        ...
        <div class="space50">&nbsp;</div>@include ('blocks/error')
         <form role="form" action="{{route('adminadd')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
               ...
               <input type="number" id = "1" name="unit_price" class="form-control" placeholder="Enter price">
            </div>
            <div class="form-group">
               ...
               <input type="number" id = "2" name="promotion_price" class="form-control" placeholder="Enter promotion">
            </div>
             <div class="form-group">
               <label for="labunit">Unit</label>
               <input type="text" id = "3" name="unit" class="form-control" placeholder="Enter unit">
             ...
             <div class="form-group">
               ...
               <input type="file" id = "exampleFormControlFile1" name="image" class="form-control" placeholder="Choose file">
             </div>
             <div class="form-group">
